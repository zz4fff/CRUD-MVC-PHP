...
<body>
  ...
  <div class="row">
    <form method="post" action="../controller/ControllerCadastrarLivro.php" id="form"
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" id="preco" name="preco" placeholder="Preço do Livro" onkeyup="formatarMoeda();" required>
