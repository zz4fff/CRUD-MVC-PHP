...
<body>
  ...
  <div class="row">
    <form method="post" action=<?php echo "../controller/ControllerEditar.php?id=".strq($editar->getNome()) ?> id="form" name="form" onsubmit="validar(document.form); return false;" class="col-10">
