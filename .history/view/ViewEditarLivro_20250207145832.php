...
<body>
  ...
  <?php require_once("../controller/ControllerEditarLivro.php"); ?>

  <div class="row">
    <form method="post" action="<?php echo '../controller/ControllerEditarLivro.php?id='.$editar->getNome() ?>" id="form" name="form" onsubmit="validar(document.form); return false;" class="col-10">
      <div class="form-group">
        ...
        <input class="form-control" type="text" id="preco" name="preco" placeholder="Preço do Livro" onkeyup="formatarMoeda();" value="<?php echo $editar->getPreco(); ?>" required>
