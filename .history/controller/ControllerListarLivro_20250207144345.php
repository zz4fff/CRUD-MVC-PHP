...
class ListarLivroController {
  ...
  private function criarTabela() {
    ...
    foreach ($row as $value) {
      ...
      echo "<td><a class='btn btn-warning' href='editar.php?id=".$value['nome']."'> <i class="fa-solid fa-pen"></i> </a><a class='btn btn-danger' href='../controller/ControllerDeletar.php?id=".$value['nome']."'> Excluir </a></td>";
      echo "</tr>";
    }
  }
}
