...
class ListarLivroController {
  ...
  private function criarTabela() {
    ...
    foreach ($row as $value) {
      ...
      echo "<td><a class='btn btn-warning' href='editar.php?id=".$value['nome']."'> Editar </a><a class='btn btn-danger' href='../controller/ControllerDeletarLivro.php?id=".$value['nome']."'> Excluir </a></td>";
      echo "</tr>";
    }
  }
}
