...
$this->cadastro = new Cadastro();
 ...
 if ($result >= 1) {
 echo "<script>alert(''Registro incluído com sucesso!''); document.cation = 
 ''../view/cadastro.php''</script>";
 } else {
 echo "<script>alert(''Erro ao gravar registro!,verifique se o livro não 
 está duplicado''); history.back()</script>";
 }
 }
 }
